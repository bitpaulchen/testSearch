    ...
    while not states.isEmpty() and not problem.isGoalState(s):
        ...
        for node in successor:
            ...
            if not coordinates in exstates:
                ...
                # print('in==>', state, coordinates, actions, direction)
...
def breadthFirstSearch(problem):
    ...
    while not states.isEmpty() and not problem.isGoalState(s):
        state, actions = states.pop()
        exstates.append(state)
        # print('cur', state, actions)
        successor = problem.getSuccessors(state)

        # print('suc==', state, successor)
        # print('out==>', state, successor)
    ...
    while not states.isEmpty():
        ...
        for node in successor:
            ...
            if not coordinates in exstates:
                ...
                states.push((coordinates, actions + [direction]), problem.getCostOfActions(newAction))
                print('in==>', state, coordinates, actions, direction)
            s = coordinates
    print(actions + [direction])
    return actions
        ...
        if state not in exstates:
            ...
            for node in successor:
                ...
                if coordinates not in exstates:
                    ...
                    states.push((coordinates, actions + [direction]), problem.getCostOfActions(newAction))
                    print('in==>', state, coordinates, actions, direction, problem.getCostOfActions(newAction))
        exstates.append(state)
    return actions
        ...
        if state not in exstates:
            ...
            for node in successor:
                ...
                if coordinates not in exstates:
                    ...
                    states.push((coordinates, actions + [direction]), newCost)
        exstates.append(state)
    return actions
